...
#include "protocol/msg_factory.hpp"
...
class Connection {
public:
    typedef boost::function<void(BaseMsg_ptr)> msg_callback_func_t;
    ...
    bool sendMsg(BaseMsg_ptr msg);

    bool sendUDPMsg(BaseMsg_ptr msg);
...
private:
    ...
    BaseMsg_ptr _read_msg();
    void _handle_msg(BaseMsg_ptr read_msg);
