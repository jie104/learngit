...
public:
    ...
    /*!
    * @brief Connect to LMS5xx.
    * @param host LMS5xx host name or ip address.
    * @param port LMS5xx port number.
    */
    void connect(std::string host, int port = 2111);

    /*!
    * @brief Disconnect from LMS5xx device.
    */
    void disconnect();
    ...
    */
    ...
    /*!
    * @brief Get current status of LMS5xx device.
    * @returns status of LMS5xx device.
    */
    status_t queryStatus();

    /*!
    * @brief Log into LMS5xx unit.
    ...
    */
    ...
    void setEchoCfg(const ScanEchoCfg &cfg);
    ...
    */
    ...
    void setScanNumberCheck(int number_check);
...
protected:
    ...
    */
    bool parseScanData(char *buf, scanData *data);

    bool connected_;
    LMSBuffer buffer_;
    int socket_fd_;
    int scan_number_check;
