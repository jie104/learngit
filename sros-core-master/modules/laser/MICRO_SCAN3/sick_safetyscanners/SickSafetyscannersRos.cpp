  ...
  , m_use_pers_conf(false)
{
  ...
  sick_safetyscanners::FieldData::Request req;
  sick_safetyscanners::FieldData::Response res;
  getFieldData(req,res);
...
void SickSafetyscannersRos::readTypeCodeSettings()
{
  ...
  LOG(INFO)<<"range max:"<<type_code.getMaxRange();
}
...
{
  std::string sensor_ip_adress = "192.168.1.2";
  ...
  std::string host_ip_adress = "192.168.1.102";
...
//  LOG(INFO) << "createApplicationInputsMessage";
