...
#ifndef IMU_READER_PROTOCOL_WRAPPER_H
#define IMU_READER_PROTOCOL_WRAPPER_H
...
extern int resendCounter;
extern unsigned char *pBufferStart;
extern unsigned char *pCustomer;
extern unsigned char *pProducer;
extern unsigned char *pCurrent;
extern unsigned char *pBufferEnd;
extern unsigned char *p;
extern unsigned char chr[RING_BUFFER_SIZE * 2];
extern unsigned char chrBuffer[RING_BUFFER_SIZE];
extern u8 ringBuf[RING_BUFFER_SIZE];

typedef int (*msg_handler)(void *data, u16 length, u16 type);
typedef int (*output_handler)(const char *data);
extern msg_handler g_imu_msg_callback;
extern output_handler g_output_info;
...
#define PACKET_IMU_TIME (1 << IMU_TIME)
...
extern char waitAck(void (*pFunction)(char x), u8 cid, u8 mid, char parameter);
extern void DataPacketParser(u8 *pBuffer, u16 dataLen);
#endif  // IMU_READER_PROTOCOL_WRAPPER_H
