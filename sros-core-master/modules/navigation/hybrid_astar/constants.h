...
static const float r = 7.5;
/// [m] --- The number of discretizations in heading
static const int headings = 4;
...
static const float penaltyTurning = 1.35;
/// [#] --- A movement cost penalty for reversing (choosing motion primitives > 2)
static const float penaltyReversing = 3.55;
/// [#] --- A movement cost penalty for change of direction (changing from primitives < 3 to primitives > 2)
static const float penaltyCOD = 4.8;
/// [m] --- The distance to the goal when the analytical solution (Dubin's shot) first triggers
static const float dubinsShotDistance = 1000;
...
static const float minRoadWidth =30; // 由于1格表示0.02m 所以如果需要0.4m则需要20格。
