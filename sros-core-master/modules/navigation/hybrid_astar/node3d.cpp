...
// R = 6, 6.75 DEG  圆弧半径为6，旋转角度为6.75度。弧长为弧度乘以半径。
...
// R=25,6.75度
//
//const float Node3D::dy[] = { 0,       0.17328, -0.17328};
//const float Node3D::dx[] = { 2.94524, 2.93843, 2.93843};
//const float Node3D::dt[] = { 0,       0.11780972451,   -0.11780972451};

// R=25,6.75度
float r =25;
float rad = 12/180.0*3.14159;

const float Node3D::dy[] = { 0,       r*(1-cosf(rad)), -r*(1-cosf(rad))};
const float Node3D::dx[] = { r*rad, r*sinf(rad), r*sinf(rad)};
const float Node3D::dt[] = { 0,       rad,   -rad};
