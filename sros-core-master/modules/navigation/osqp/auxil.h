...
/**
 * Compute osqp_rho estimate from residuals
 * @param work Workspace
 * @return     osqp_rho estimate
 */
c_float compute_rho_estimate(OSQPWorkspace *work);

/**
 * Adapt osqp_rho value based on current unscaled primal/dual residuals
 * @param work Workspace
 * @return     Exitflag
 */
...
/**
 * Set values of osqp_rho vector based on constraint types
 * @param work Workspace
 */
void    set_rho_vec(OSQPWorkspace *work);

/**
 * Update values of osqp_rho vector based on updated constraints.
