...
/**
 * Update osqp_rho. Limit it between RHO_MIN and RHO_MAX.
 * @param  work         Workspace
 * @param  rho_new      New osqp_rho setting
 * @return              Exitflag
 */
...
/**
 * Update osqp_max_iter setting
 * @param  work         Workspace
 * @param  max_iter_new New osqp_max_iter setting
 * @return              Exitflag
 */
