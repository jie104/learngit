...
// (in-package plumbing_service_client.srv)
...
class AddintsRequest {
  ...
  static datatype() {
    ...
    return 'plumbing_service_client/AddintsRequest';
  }
...
class AddintsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'plumbing_service_client/AddintsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'plumbing_service_client/Addints'; }
};
